...
//  g3 :  10%  27dBm  
//                 freq             band     datarates
#define ZTE470_FREQ_BASE_UL            482300000
#define ZTE470_FREQ_BASE_DL            482300000

enum { ZTE470_CHNL_PING         = 5 };
enum { ZTE470_FREQ_PING         = 482300000 };  // default ping freq
enum { ZTE470_DR_PING           = SF9 };       // default ping DR
enum { ZTE470_CHNL_DNW2         = 5 };
enum { ZTE470_FREQ_DNW2         = 482300000 };
enum { ZTE470_DR_DNW2           = DR_SF12 };
enum { ZTE470_CHNL_BCN          = 5 };
enum { ZTE470_FREQ_BCN          = 482300000 };
enum { ZTE470_DR_BCN            = DR_SF9 };
enum { ZTE470_AIRTIME_BCN       = 144384 };  // micros

enum {
    // Beacon frame format EU SF9
    ZTE470_OFF_BCN_NETID    = 0,
    ZTE470_OFF_BCN_TIME     = 3,
    ZTE470_OFF_BCN_CRC1     = 7,
    ZTE470_OFF_BCN_INFO     = 8,
    ZTE470_OFF_BCN_LAT      = 9,
    ZTE470_OFF_BCN_LON      = 12,
    ZTE470_OFF_BCN_CRC2     = 15,
    ZTE470_LEN_BCN          = 17
};
...
#if defined(CFG_zte470)
    ZTE470_MCMD_LADR_SF12      = DR_SF12<<4,
    ZTE470_MCMD_LADR_SF11      = DR_SF11<<4,
    ZTE470_MCMD_LADR_SF10      = DR_SF10<<4,
    ZTE470_MCMD_LADR_SF9       = DR_SF9 <<4,
    ZTE470_MCMD_LADR_SF8       = DR_SF8 <<4,
    ZTE470_MCMD_LADR_SF7       = DR_SF7 <<4,
    ZTE470_MCMD_LADR_SF7B      = DR_SF7B<<4,
    ZTE470_MCMD_LADR_FSK       = DR_FSK <<4,

    ZTE470_MCMD_LADR_20dBm     = 0,
    ZTE470_MCMD_LADR_14dBm     = 1,
    ZTE470_MCMD_LADR_11dBm     = 2,
    ZTE470_MCMD_LADR_8dBm      = 3,
    ZTE470_MCMD_LADR_5dBm      = 4,
    ZTE470_MCMD_LADR_2dBm      = 5,
#endif
