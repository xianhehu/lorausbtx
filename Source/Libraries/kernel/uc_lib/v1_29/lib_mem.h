...
*                   (i.e. volatile) variables, registers, hardware, etc.
*
...
*                   static (i.e. volatile) variables, registers, hardware, etc.
*
...
*
*               (6) MEM_VAL_COPY_SET_xxx() macro's are NOT atomic operations & MUST NOT be used on any non-
*                   static (i.e. volatile) variables, registers, hardware, etc.
*********************************************************************************************************
*/
