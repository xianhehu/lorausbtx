...
#define  CPU_CFG_CRITICAL_METHOD    CPU_CRITICAL_METHOD_KPSDK
...
#elif   (CPU_CFG_CRITICAL_METHOD == CPU_CRITICAL_METHOD_KPSDK)
extern void INT_SYS_DisableIRQGlobal(void);
extern void INT_SYS_EnableIRQGlobal(void);
/* __enable_irq()
#define CPU_INT_DIS()  INT_SYS_DisableIRQGlobal()
#define  CPU_INT_EN()  INT_SYS_EnableIRQGlobal()
*/
#define CPU_INT_DIS()     __disable_interrupt()
#define CPU_INT_EN()      __enable_interrupt()
#endif
