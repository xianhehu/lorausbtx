...
extern UBXMsgBuffer getCFG_MSG_RATE(UBXU1_t msgClass, UBXU1_t msgId, UBXU1_t rate);
...
extern UBXMsgBuffer getCFG_PRT_UART(UBXU1_t portId, UBXU4_t baud);
...
extern UBXMsgBuffer getNAV_SAT_POLL();
extern UBXMsgBuffer getNAV_PVT_POLL();
extern UBXMsgAck getUBXMsgAck(uint8_t *data, uint16_t len);
